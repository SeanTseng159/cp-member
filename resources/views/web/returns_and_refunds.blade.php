...
<div class="tabs-content">
    <div class="terms-content styel2">
        ...
        <p>· 商品辦理退訂/退貨，請點選下載《<a class="btn-link" href="https://middleware.citypass.tw/files/citypass_returnV2.docx">退貨申請</a>》填寫欲退貨品項、數量、點選退貨原因，包含訂單編號與電子信箱，並同意代為進行發票折讓，寄送完成申請至客服信箱service@citypass.tw，客服人員於三天內將儘快與您聯繫確認。</p>
        ...
        <p class="color-blue">退換貨說明</p>
        <p>· 依據消費者保護法之規定，消費者得於收到商品七天內，以退回商品或書面通知方式解除契約。商品須在完整、未使用狀態且可還原狀態下，才能進行退貨，但以下情形無法辦理退貨：</p>
